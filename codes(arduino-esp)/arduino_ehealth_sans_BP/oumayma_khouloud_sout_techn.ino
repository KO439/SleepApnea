...
void setup() {
    ...
    noTone(buzzer);          // Assurez-vous que le buzzer est éteint au démarrage

    while (!particleSensor.begin()) {
        
    }

    mySerial.println(F("Attachez le capteur au doigt avec un élastique. Appuyez sur n'importe quelle touche pour commencer la conversion"));
